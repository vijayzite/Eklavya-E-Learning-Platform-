...
public class SubTopic {
	...
	@ManyToOne
	private Chapter chapter; //many subtopics belongs to one chapter chapter 
...
//	}
	...
	public SubTopic(Long subtId, String subtIndexNo, String subtTitle, String subtDesc, String subt_ThumbPath,
			String subtFilePath, String subtVideoPath, Chapter chapter, Course courseid) {
		super();
		this.subtId = subtId;
	...
	public void setSubt_ThumbPath(String subtThumbPath) {
