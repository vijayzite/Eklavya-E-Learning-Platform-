...
//import com.backend.elearning.models.Role;
...
//
//	/*
//	 * @PostMapping("/register") public String userRegistration(@RequestBody User
//	 * userToRegister) { System.out.println("request hit" +
//	 * userToRegister.toString()); return registerService.register(userToRegister);
//	 * }
//	 * 
//	 * @PostMapping("/login") public String userLogin(@RequestBody User obj) {
//	 * System.out.println("inside login"); String username = obj.getUserName();
//	 * String uname = registerService.getUserName(username);
//	 * System.out.println(username + " " + uname);
//	 * 
//	 * // LoginInfo loginInfo = new LoginInfo();
//	 * 
//	 * // password if (uname == null) {
//	 * 
//	 * // loginInfo.setMessage("Username not found, Please Register First!"); return
//	 * ""; } else {
//	 * 
//	 * if (uname.equals(username)) { String pass = obj.getPass(); String pwd =
//	 * registerService.getPassword(uname);
//	 * 
//	 * if (pwd == null) { // loginInfo.setMessage("Incorrect Password"); return "";
//	 * }
//	 * 
//	 * if (pwd.equals(pass)) { // get role id Integer roleid =
//	 * registerService.getUserRoleId(uname);
//	 * 
//	 * // loginInfo.setRoleId(roleid); // loginInfo.setUserName(uname); //
//	 * loginInfo.setMessage("Login Sucessfull");
//	 * 
//	 * return uname; } else {
//	 * 
//	 * // loginInfo.setMessage("Incorrect Password"); return ""; }
//	 * 
//	 * } else { // loginInfo.setMessage("Incorrect Password"); return ""; } } }
//	 * 
//	 * // get rolename by username
//	 * 
//	 * @PostMapping("/rolename") public String getUserRoleName(@RequestBody User
//	 * user) { System.out.println("rolename=" + user.getUserName()); return
//	 * registerService.getUserRoleName(user.getUserName()); }
//	 * 
//	 * @PostMapping("/user/getuid/{userInfo}") public String
//	 * getUserIdByUserName(@PathVariable String userInfo) {
//	 * 
//	 * String result = registerService.getUserIDByUserName(userInfo);
//	 * 
//	 * return result; }
//	 * 
//	 * @PostMapping("/getuid") public String getUserIdByUserName(@RequestBody User
//	 * user) { System.out.println("username=" + user.getUserName()); String result =
//	 * registerService.getUserIDByUserName(user.getUserName());
//	 * System.out.println(result); return result; }
//	 */
//	/*
//	 * @PostMapping("/addcourse") public String addNewCourse(@RequestBody Course
//	 * course) { return instructorService.saveCourse(course); }
//	 * 
//	 * @PostMapping("/addchapter") public String addNewChapter(@RequestBody Topic
//	 * chapter) { return instructorService.saveChapter(chapter); }
//	 * 
//	 * @PostMapping("/addsubtopic") public String addNewSubtopic(@RequestBody
//	 * SubTopic subtopic) { return instructorService.saveSubtopic(subtopic); }
//	 */
//	/*
//	 * @PostMapping("/file/uploadimg") public ResponseEntity<FileResponce>
//	 * uploadFile(@RequestParam("image") MultipartFile image,
//	 * 
//	 * @RequestParam("courseId") Course courseId, @RequestParam("userId") User
//	 * userId,
//	 * 
//	 * @RequestParam("chapterId") Topic chapterId, @RequestParam("subtId") SubTopic
//	 * subtId) { System.out.println("file moule responce:");
//	 * System.out.println("cid:" + courseId.getCourseId()); //
//	 * System.out.println("cid:" + userID); System.out.println("file name full:" +
//	 * image.getOriginalFilename());
//	 * 
//	 * String fileName = null; // MultipartFile image = course.getImage(); try {
//	 * fileName = fileService.uploadImage(path, image, courseId, userId, chapterId,
//	 * subtId); System.out.println("filename: " + image.getName());
//	 * 
//	 * // after upload save file path in respective table(update field value)
//	 * System.out.println("path: " + path);
//	 * 
//	 * } catch (IOException e) { // TODO Auto-generated catch block return new
//	 * ResponseEntity<>(new FileResponce(null, "Video is could not upload"),
//	 * HttpStatus.INTERNAL_SERVER_ERROR);
//	 * 
//	 * } return new ResponseEntity<>(new FileResponce(fileName,
//	 * "Video is successfully uploaded"), HttpStatus.OK); }
//	 * 
//	 * // download image
//	 * 
//	 * @GetMapping(value = "/download/{imageName}", produces =
//	 * MediaType.MULTIPART_FORM_DATA_VALUE) public void
//	 * downloadImage(@PathVariable("imageName") String imageName,
//	 * HttpServletResponse response) throws IOException {
//	 * System.out.println("in download file"); InputStream resource =
//	 * fileService.getResources(path, imageName);
...
//	/*
//	 * @PostMapping("/student/enrolled/courses/{userId}") public
//	 * List<EnrolledCourseData> getEnrolledCoursesList(@PathVariable Long userId) {
//	 * 
//	 * List<EnrolledCourseData> cList = new ArrayList<EnrolledCourseData>();
//	 * 
//	 * List<EnrolledCourses> cl =
//	 * enrolledCoursesService.getEnrollmentByUserID(userId);
//	 * 
...
//	 * cd.setCourseTitle(course.getCourseTitle());
//	 * cd.setCourseType(course.getCourseType()); cd.setuId(course.getuId());
...
//	 * 
//	 * @PostMapping("/student/enrollment") public String
//	 * saveCourseEnrollment(@RequestBody EnrolledCourses course) {
//	 * 
//	 * // enroll list of courses enrolledCoursesService.saveCourseEnroll(course);
//	 * 
//	 * // send email
//	 * 
...
//	 * 
//	 * @PostMapping("/instructor/getapprove") public String getApprove(@RequestBody
//	 * Aproove approve) {
//	 * 
//	 * aprooveRepository.save(approve); return
//	 * "Your request submitted for approval."; }
//	 * 
//	 * // get list of records for approval on admin dash
//	 * 
//	 * @GetMapping("/admin/approve/instructor") public List<ApproveData>
//	 * getApproveList() { System.out.println("in call");
//	 * 
...
//	 * 
//	 * cd.setApvId(apr.getApvId()); cd.setCerti(apr.getCerti());
//	 * cd.setDesc(apr.getDesc()); cd.setQualification(apr.getQualification());
//	 * cd.setExp(apr.getExp()); // course id cd.setStatus(apr.getStatus()); //
//	 * course id cd.setUiId(apr.getUiId()); // course id
//	 * 
//	 * cList.add(cd);
//	 * 
//	 * }
...
//	// ------------------------- PLACE ORDER ----------------------------------
//	/*
//	 * @PostMapping("/user/order") public String
//	 * placeOrderDataAndSendMail(@RequestBody OrderData ord) {
//	 * 
//	 * String userId = registerService.getUserIDByUserName(ord.getUserName());
//	 * String userName = ord.getUserName(); Float total = ord.getTotalAmt();
//	 * 
...
//	 * Order or = new Order();
//	 * 
//	 * or.setTotalAmt(total); or.setUserName(userName); // Long uid =
//	 * Long.parseLong(userId); User uss = new User();
//	 * uss.setUserId(Long.parseLong(userId)); or.setUser(uss); or.setOrdDate(date);
//	 * 
//	 * // save order orderService.saveOrder(or);
//	 * 
//	 * // list cources List<Course> list = ord.getCources();
//	 * 
//	 * String msg = "";
//	 * 
//	 * for (Course el : list) {
//	 * 
//	 * // add list of selected coures to mail msg = msg + "" + el.getCourseTitle() +
//	 * "\t\t" + el.getCoursePrice() + "\n";
//	 * 
//	 * // save db
//	 * 
//	 * // save enrolled course // enrolledCoursesService.saveCourseEnroll(null);
//	 * 
//	 * // save order EnrolledCourses ec = new EnrolledCourses();
//	 * 
//	 * ec.setCourseTitle(el.getCourseTitle()); ec.setcId(el.getCourseId());
//	 * ec.setCourseType(el.getCourseType()); ec.setuId(Long.parseLong(userId));
//	 * 
//	 * // save to db enrolledCoursesService.saveCourseEnroll(ec);
//	 * 
//	 * // save to enroll details EnrollDetails ed = new EnrollDetails();
//	 * 
//	 * // fetch price by cid Float price =
//	 * courseRepository.getPriceCourse(el.getCourseId()); ed.setPrice(price);
//	 * ed.setcId(el.getCourseId());
//	 * 
//	 * // fetch instru id for this course Long instId =
//	 * courseRepository.getInstIdCourseId(el.getCourseId()); ed.setUserId(instId);
//	 * 
...
//	 * 
//	 * String toEmail = registerService.getUserEmail(userName); String fName =
//	 * registerService.getUserFirstName(userName); String lName =
//	 * registerService.getUserLastName(userName); String clientFullName = fName +
//	 * lName; String subject = clientFullName + "-Order(#527)" + userId; String
//	 * billing = "\n------------------------------------------\n" + "Total : " +
//	 * total; String header = "Hello," + "\n\n" + "Your Order Detals" + "\n\n" +
//	 * "Course Name" + "\t" + "Price" +
//	 * "\n--------------------------------------\n";
//	 * 
